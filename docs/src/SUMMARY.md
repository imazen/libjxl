...
- [Base Primitives](foundations/base-primitives.md)
...
- [ANS Theory](entropy/ans-theory.md)
- [ANS Implementation](entropy/ans-implementation.md)
- [Hybrid Integers](entropy/hybrid-integers.md)
- [Histogram Clustering](entropy/histogram-clustering.md)
- [LZ77](entropy/lz77.md)
- [Context Modeling](entropy/context-modeling.md)

# Color Science

- [XYB Color Space](color/xyb-color-space.md)
...
- [DCT Family](transforms/dct-family.md)
- [AC Strategy](transforms/ac-strategy.md)
- [Coefficient Order](transforms/coefficient-order.md)
...
- [Reversible Color Transform](modular/rct.md)
- [Squeeze Transform](modular/squeeze.md)
- [Palette Mode](modular/palette.md)
- [Prediction & MA Trees](modular/prediction-trees.md)
...
- [Pipeline Overview](encoder/pipeline-overview.md)
- [Frame Setup](encoder/frame-setup.md)
